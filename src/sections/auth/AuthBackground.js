...
const AuthBackground = () => {
  ...
  return (
    <Box sx={{ position: 'absolute', filter: 'blur(10px)', zIndex: -1, bottom: 0 }}>
      <img src='https://images.unsplash.com/photo-1524178232363-1fb2b075b655?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3870&q=80'></img>
     { false&& <svg width="100%" height="calc(100vh - 175px)" viewBox="0 0 405 809" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
        ...
        <path
          ...
          fill={theme.palette.warning.lighter}
