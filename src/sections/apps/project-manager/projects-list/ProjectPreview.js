...
export default function ProjectPreview({course, customer, open, onClose }) {
  ...
  //PDF EXPORT DISABLED DUE TO DOM ISSUES.. TO BE REIMPORTED FROM CUSTOMER APP
  return (
    <>
      <Dialog
        open={open}
              ...
              >
                <ListItemAvatar sx={{ mr: 0.75 }}>
                  <Avatar
                    ...
                    size="lg"
                    src={`/assets/images/users/avatar-${!"bolb" ? 1 : "bob"}.png`}
                  />
                </ListItemAvatar>
                <ListItemText
                  primary={<Typography variant="h5">{"bob"}</Typography>}
                  secondary={<Typography color="secondary">{"bob"}</Typography>}
                />
              </ListItem>
            </List>
          </DialogTitle>
                  ...
                  <Grid container spacing={2.25}>
                    <Grid item xs={12}>
                      <MainCard title="About me">
                        <Typography>
                          Hello, Myself {"bob"}, I’m {"bob"} in international company, {"bob"}
                        </Typography>
                      </MainCard>
                    </Grid>
                    <Grid item xs={12}>
      ...
      <AlertProjectDelete title={customer.fatherName} open={openAlert} handleClose={handleClose} />
    </>
  );
}
